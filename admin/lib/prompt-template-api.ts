...
/**
 * 提示词模板API客户端
 * 使用 axiosInstance 确保所有请求都带有认证 token
 */
export const promptTemplateApi = {
  ...
  list: async (params?: {
    ...
    const response = await axiosInstance.get('/api/prompt-templates/', { params })
    // axiosInstance.get 返回 ApiResponse<T> 格式: { code, message, data }
  ...
  get: async (id: number): Promise<PromptTemplate> => {
    const response = await axiosInstance.get(`/api/prompt-templates/${id}`)
  ...
  create: async (data: PromptTemplateCreate): Promise<PromptTemplate> => {
    const response = await axiosInstance.post('/api/prompt-templates/', data)
    return response.data
  },
  ...
  update: async (id: number, data: PromptTemplateUpdate): Promise<PromptTemplate> => {
    const response = await axiosInstance.put(`/api/prompt-templates/${id}`, data)
    return response.data
  },
  ...
  delete: async (id: number): Promise<void> => {
    await axiosInstance.delete(`/api/prompt-templates/${id}`)
  },
  ...
  createVersion: async (
    ...
    const response = await axiosInstance.post(`/api/prompt-templates/${id}/versions`, data)
    return response.data
  },
  ...
  deactivate: async (id: number): Promise<PromptTemplate> => {
    const response = await axiosInstance.post(`/api/prompt-templates/${id}/deactivate`)
    return response.data
  },
  ...
  preview: async (
    ...
    const response = await axiosInstance.post(`/api/prompt-templates/${id}/preview`, { variables })
    return response.data
  },
  ...
  getStatistics: async (id: number): Promise<PromptTemplateStatistics> => {
    const response = await axiosInstance.get(`/api/prompt-templates/${id}/statistics`)
    return response.data
  },
  ...
  getHistory: async (id: number, limit: number = 50): Promise<PromptTemplateHistory[]> => {
    const response = await axiosInstance.get(`/api/prompt-templates/${id}/history`, {
      params: { limit }
    })
    return response.data
  },
  ...
  getBusinessTypes: async (): Promise<string[]> => {
    const response = await axiosInstance.get('/api/prompt-templates/business-types/all/')
    return response.data
  },
  ...
  getByKey: async (key: string): Promise<PromptTemplate> => {
    const response = await axiosInstance.get(`/api/prompt-templates/by-key/${key}`)
    return response.data
  },
  ...
  updateByKey: async (key: string, data: PromptTemplateUpdate): Promise<PromptTemplate> => {
    const response = await axiosInstance.put(`/api/prompt-templates/by-key/${key}`, data)
    return response.data
  },
  ...
  deleteByKey: async (key: string): Promise<void> => {
    await axiosInstance.delete(`/api/prompt-templates/by-key/${key}`)
  },
  ...
  deactivateByKey: async (key: string): Promise<PromptTemplate> => {
    const response = await axiosInstance.post(`/api/prompt-templates/by-key/${key}/deactivate`)
    return response.data
  },
  ...
  createVersionByKey: async (
    ...
    const response = await axiosInstance.post(`/api/prompt-templates/by-key/${key}/versions`, data)
    return response.data
  },
  ...
  previewByKey: async (
    ...
    const response = await axiosInstance.post(`/api/prompt-templates/by-key/${key}/preview`, { variables })
    return response.data
  },
  ...
  getStatisticsByKey: async (key: string): Promise<PromptTemplateStatistics> => {
    const response = await axiosInstance.get(`/api/prompt-templates/by-key/${key}/statistics`)
    return response.data
  },
  ...
  getHistoryByKey: async (key: string, limit: number = 50): Promise<PromptTemplateHistory[]> => {
    const response = await axiosInstance.get(`/api/prompt-templates/by-key/${key}/history`, {
      params: { limit }
    })
    return response.data
  },
