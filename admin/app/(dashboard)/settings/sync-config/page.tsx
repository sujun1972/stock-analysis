        ...
        <DialogContent className="sm:max-w-[560px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-3 items-center gap-4">
              ...
              <Input
                className="col-span-2 font-mono text-sm" placeholder="如 income_vip"
                value={editForm.api_name ?? ''}
                onChange={e => setEditForm(prev => ({ ...prev, api_name: e.target.value || null }))}
              />
            </div>
            <div className="grid grid-cols-3 items-center gap-4">
              <Label className="text-right text-sm">文档链接</Label>
              <Input
                className="col-span-2 text-sm" placeholder="https://tushare.pro/document/..."
                value={editForm.doc_url ?? ''}
                onChange={e => setEditForm(prev => ({ ...prev, doc_url: e.target.value || null }))}
              />
            </div>
