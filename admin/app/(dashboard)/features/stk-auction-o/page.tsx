...
export default function StkAuctionOPage() {
  ...
  const dp = useDataPage<StkAuctionOData, StkAuctionOStatistics>({
    apiCall: (params) => stkAuctionOApi.getData(params),
    syncFn: (params) => stkAuctionOApi.syncAsync(params),
    ...
    syncSuccessMessage: '开盘集合竞价数据同步完成',
  })
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        details={<>
          <div>接口：stk_auction_o</div>
          <a href="https://tushare.pro/document/2?doc_id=353" target="_blank" rel="noopener noreferrer">查看文档</a>
        </>}
        actions={
