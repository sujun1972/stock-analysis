...
- 东财概念板块行情页面（`/boardgame/dc-daily`）**（✨ 新增于 2026-03-25，Tushare dc_daily接口，6000积分/次，单次最大2000条，获取东方财富概念/行业/地域板块OHLCV行情数据（收盘/开盘/最高/最低点位、涨跌点、涨跌幅、成交量、成交额、振幅、换手率），历史数据从2020年开始，所有参数可选，归属打板专题菜单）**
