...
('stk_shock',       '个股异常波动',       '参考数据', 450,
 ...
 'tasks.sync_stk_shock_full_history', 'by_month', 5,
 FALSE, NULL,
 '/reference-data/stk-shock', '/stk-shock', 6000, '按月切片全量同步，增量按日期范围'),

('stk_high_shock',  '个股严重异常波动',   '参考数据', 451,
 'tasks.sync_stk_high_shock', 30,
 'tasks.sync_stk_high_shock_full_history', 'by_month', 5,
 FALSE, NULL,
 '/reference-data/stk-high-shock', '/stk-high-shock', 6000, '按月切片全量同步，增量按日期范围'),

('stk_alert',       '交易所重点提示证券', '参考数据', 452,
 'tasks.sync_stk_alert', 30,
 'tasks.sync_stk_alert_full_history', 'by_month', 5,
 FALSE, NULL,
 '/reference-data/stk-alert', '/stk-alert', 6000, '按月切片全量同步，增量按日期范围'),

('pledge_stat',     '股权质押统计',       '参考数据', 453,
 'tasks.sync_pledge_stat', 90,
 'tasks.sync_pledge_stat_full_history', 'by_ts_code', 5,
 FALSE, NULL,
 '/reference-data/pledge-stat', '/pledge-stat', 500, '全量策略可配置（by_ts_code/snapshot），默认逐只股票请求'),
