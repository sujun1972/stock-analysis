...
2. **对比 Backend 实现** (半天)
   ...
   # 找出 Backend 中重复的功能
   # 例如：
   # Backend: services/database_service.py -> Core: database/data_query_manager.py
   # Backend: services/feature_service.py -> Core: features/feature_engineer.py
   ```

**验收标准**:
- ✅ 完整的 Core 功能清单（Markdown 表格）
- ✅ Backend vs Core 功能对比表
- ✅ 识别所有重复代码

---

#### 任务 0.2: 创建 Core Adapters (P0)
...
**验收标准**:
- ✅ 至少 3 个 Adapter 已创建（Data, Feature, Backtest）
- ✅ 所有 Adapter 方法都是异步的
- ✅ 单元测试通过
