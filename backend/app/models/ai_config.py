...
class AIProviderConfig(Base):
    ...
    rate_limit = Column(Integer, default=10, comment="每分钟请求限制 (RPM)")
    max_concurrent = Column(Integer, nullable=True, comment="LLM 并发请求上限（进程内 Semaphore），NULL=按 provider 默认")
