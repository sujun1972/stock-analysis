...
def sync_hsgt_top10_full_history_task(self, start_date: Optional[str] = None, concurrency: int = 5):
    """
    ...
    logger.info(f"========== [Celery] 开始全量历史沪深股通十大成交股同步任务 concurrency={concurrency} ==========")
