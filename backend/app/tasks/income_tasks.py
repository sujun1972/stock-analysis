...
def sync_income_full_history_task(self, start_date: str = None, concurrency: int = 5):
    """
    ...
    logger.info(f"========== [Celery] 开始全量利润表数据同步任务，start_date={start_date}, concurrency={concurrency} ==========")
