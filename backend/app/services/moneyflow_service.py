...
class MoneyflowService:
    ...
    def get_moneyflow_data(
        ...
        Examples:
            ...
            >>> result = service.get_moneyflow_data(ts_code='000001.SZ', start_date='2024-01-01')
        """
        # 1. 日期格式转换（业务逻辑）
        ...
        items = self.moneyflow_repo.get_by_date_range(
            start_date=start_date_fmt or '19900101',  # 默认起始日期
            end_date=end_date_fmt or '29991231',      # 默认结束日期
            ts_code=ts_code,
            limit=limit,
            offset=offset
        )
