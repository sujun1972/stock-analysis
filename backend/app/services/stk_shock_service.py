...
class StkShockService(TushareSyncBase):
    """个股异常波动服务"""

    TABLE_KEY = 'stk_shock'
    FULL_HISTORY_START_DATE = '20050101'
    FULL_HISTORY_PROGRESS_KEY = 'sync:stk_shock:full_history:progress'
    ...
    async def sync_full_history(
        ...
        return await self.run_full_sync(
            ...
            fetch_fn=provider.get_stk_shock,
            upsert_fn=self.stk_shock_repo.bulk_upsert,
    ...
    async def sync_incremental(
        ...
        return await self.sync_stk_shock(
            start_date=start_date,
            end_date=end_date,
