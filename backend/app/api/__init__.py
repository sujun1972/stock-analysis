...
router.include_router(stock_data_collection.router)
...
router.include_router(stock_st.router, prefix="/stock-st", tags=["ST股票列表"])  # ST股票列表API
router.include_router(data_ops.router, prefix="/data-ops", tags=["数据操作"])
router.include_router(sync_dashboard.router, prefix="/sync-dashboard", tags=["同步任务管理"])
