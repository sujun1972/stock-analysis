...
| 任务ID | 任务名称 | 工作量 | 依赖 |
|-------|---------|--------|------|
| **ML-1** | MLSelector 基类实现 | 1天 | T1 |
| **ML-2** | 多因子加权模型 | 1天 | ML-1 |
| **ML-3** | LightGBM 排序模型 | 2天 | ML-1 |
| **ML-4** | 因子库集成 | 1天 | ML-1 |
| **ML-5** | 模型训练工具 | 2天 | ML-3 |
| **ML-6** | 单元测试 | 1天 | ML-1~5 |
| **合计** | - | **8天** | - |
...
| 阶段 | 任务 | 工作量 |
|------|------|--------|
| Week 1 | ML-1: MLSelector 基类 | 1天 |
| Week 1 | ML-2: 多因子加权 | 1天 |
| Week 2 | ML-4: 因子库集成 | 1天 |
| Week 2-3 | ML-3: LightGBM 模型 | 2天 |
| Week 3 | ML-5: 模型训练工具 | 2天 |
| Week 3 | ML-6: 测试 | 1天 |
...
**结论**：✅ **强烈推荐在 Core 内部实现 StarRanker 功能**

通过 MLSelector，可以在保持架构灵活性的同时，完全自主控制选股逻辑，无需依赖外部服务。
